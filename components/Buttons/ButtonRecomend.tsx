const ButtonRecomend = () => {
    ...
    <div className="group relative md:w-28 md:h-28 w-20 h-20 rounded-full bg-[#1ca6af] hover:bg-gray-400 transition duration-300 flex items-center justify-center p-3 mx-auto">
