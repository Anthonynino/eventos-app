            ...
            <div className=' flex w-full items-start p-12 overflow-auto'>
                <form action="" className='w-full'>
                    <div className='border-l-2 border-gray-100 pl-3 w-full '>
                        <h2 className='font-display text-3xl capitalize text-[#f7628c] font-light'>
                            Crear
                        </h2>
                    ...
                    <div className='flex flex-col gap-5 py-6 w-full'>
                        ...
                        <div className=' relative* w-full h-full col-spanundefined content-between'>
                            <label htmlFor="" className=' font-display text-sm text-[#f7628c] w-full'>
                            Tipo de evento
                            </label>
                        ...
                        <div className=' w-full h-max relative'>
                            <label htmlFor="" className=' font-display text-[#f7628c] text-sm w-full'>Fecha del evento</label>
                            <div className=' w-full relative flex items-center'>
                        ...
                        <button className='font-display rounded-full mt-4 py-2 px-6 text-white font-medium transition w-full hover:opacity-70 bg-[#f7628c]'>
                            Guardar
                        </button>
                    </div>
                </form>
