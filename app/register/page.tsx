                        ...
                        <div className=" flex flex-col items-center gap-4 w-full px-10 md:px-0 sm:w-3/4 md:w-2/3  ">
                            <div className="h-full">
                                <div className="flex flex-col items-center justify-center w-full h-6 mb-4">
                                    <svg width="180" height="24" viewBox="0 0 300 39" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-auto text-[#f7628c] h-10">
                                ...
                                <form action="" className=" text-gray-200 flex flex-col gap-4 py-3 w-full *md:w-3/4 ">
                                    ...
                                    <button className="hover:opacity-90 transition focus:outline-none focus:ring-4 focus:ring-pink-300 font-medium rounded-full text-sm px-2 py-2.5 text-center mr-2 mb-2 text-white bg-[#f7628c]">
                                        Registrar
                                    </button>
                                </form>
